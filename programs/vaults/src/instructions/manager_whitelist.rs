...
use crate::state::{
    ManagerWhitelist, ManagerWhitelistError, WhitelistManagerAdded, WhitelistManagerRemoved,
};
...
pub fn _remove_manager(ctx: Context<ModifyManagerWhitelist>, manager_pubkey: Pubkey) -> Result<()> {
